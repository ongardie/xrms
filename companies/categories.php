...
if ($rst) {
	while (!$rst->EOF) {
		$associated_with .= "<a href='remove-category.php?company_id=$company_id&category_id=" . $rst->fields['category_id'] . "'>" . $rst->fields['category_pretty_name'] . "</a><br>";
...
if ($rst) {
	while (!$rst->EOF) {
		$not_associated_with .= "<a href='add-category.php?company_id=$company_id&category_id=" . $rst->fields['category_id'] . "'>" . $rst->fields['category_pretty_name'] . "</a><br>";
		$rst->movenext();
	}
	$rst->close();
}
