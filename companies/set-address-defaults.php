...
$sql = "update companies set default_billing_address = $default_billing_address, default_shipping_address = $default_shipping_address, default_payment_address = $default_payment_address where company_id = $company_id";
