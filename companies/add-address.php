 ...
 * Add an address
 *
 * $Id: add-address.php,v 1.17 2006/04/21 21:43:06 braverock Exp $
 */
...
$address_id = add_update_address($con, $rec, false, get_magic_quotes_gpc());
if ($address_id) {
 ...
 * Revision 1.17  2006/04/21 21:43:06  braverock
