...
function set_datetime_format($con,$user_id=0) {
...
//$con->debug = 1;
	...
	$sql_datetime_format = "SELECT * FROM user_preferences WHERE user_preference_type_id='$type_id' AND user_id = '$user_id'";
	$rst_datetime_format = $con->execute($sql_datetime_format);
	$datetime_format = $rst_datetime_format->fields['user_preference_value'];
	if (!$datetime_format) {
		$sql_datetime_format = "SELECT * FROM user_preferences WHERE user_preference_type_id='$type_id' AND user_id = '0'";
		$rst_datetime_format = $con->execute($sql_datetime_format);
		$datetime_format = $rst_datetime_format->fields['user_preference_value'];
		}
