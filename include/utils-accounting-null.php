...
function update_vendor_profile_information() {
}

function update_customer_profile_information() {
}

function add_sales_order_to_accounting_system() {
}

function add_purchase_order_to_accounting_system() {
}
