 ...
 * @author Neil Roberts
 *
 * $Id: sidebar.php,v 1.17 2004/12/01 18:22:12 vanmer Exp $
 */
...
$sql = "SELECT * FROM relationship_types WHERE ((from_what_table=".$con->qstr($on_what_table) . " OR to_what_table=".$con->qstr($on_what_table) . ") AND relationship_status='a')";
