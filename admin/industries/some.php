 ...
 * Manage Industries
 *
 * $Id: some.php,v 1.10 2007/10/17 15:13:27 randym56 Exp $
 */
...
if ($rst) {
    while (!$rst->EOF) {
        $table_rows .= '<tr>';
        $table_rows .= '<td class=widget_content>' . $rst->fields['industry_id'] . '</td>';
        $table_rows .= '<td class=widget_content>' . $rst->fields['industry_short_name'] . '</td>';
        ...
        $table_rows .= '<td class=widget_content>' . $rst->fields['industry_pretty_plural'] . '</td>';
        $table_rows .= '<td class=widget_content>' . $rst->fields['industry_display_html'] . '</td>';
        $table_rows .= '</tr>';
        $rst->movenext();
    }
    $rst->close();
...
<div id="Main">
    <div id="Content">
        ...
        <table class=widget cellspacing=1>
            <tr>
                <td class=widget_header colspan=5><?php echo _("Industries"); ?></td>
            </tr>
            <tr>
...
/**
 * $Log: some.php,v $
 * Revision 1.10  2007/10/17 15:13:27  randym56
