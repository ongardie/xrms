...
$sql = "update campaign_statuses set campaign_status_short_name = " . $con->qstr($campaign_status_short_name, get_magic_quotes_gpc()) . ", campaign_status_pretty_name = " . $con->qstr($campaign_status_pretty_name, get_magic_quotes_gpc()) . ", campaign_status_pretty_plural = " . $con->qstr($campaign_status_pretty_plural, get_magic_quotes_gpc()) . ", campaign_status_display_html = " . $con->qstr($campaign_status_display_html, get_magic_quotes_gpc()) . " WHERE campaign_status_id = $campaign_status_id";
$con->execute($sql);
