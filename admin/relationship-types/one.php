 ...
 * Edit roles
 *
 * $Id: one.php,v 1.1 2004/07/12 18:47:59 neildogg Exp $
 */
...
$page_title = "Relationship Type: $relationship_name";
...
<div id="Main">
    <div id="Content">
		...
		<table class=widget cellspacing=1>
			<tr>
				<td class=widget_header colspan=2>Edit Role Information</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class=widget_content_form_element><input type=text size=20 name=to_what_table value="<?php  echo $to_what_table; ?>"></td>
                        ...
                        <tr>
                                <td class=widget_label_right>Pre Formatting</td>
                        ...
                        <tr>
                                <td class=widget_label_right>Post Formatting</td>
		...
		<input type=hidden name=relationship_type_id value="<?php  echo $relationship_type_id; ?>" onsubmit="javascript: return confirm('Delete Relationship Type?');">
		<table class=widget cellspacing=1>
			<tr>
			...
			<tr>
				...
				Click the button below to remove this role from the system.
                                <p>You should NOT delete the last element of a relationship type, or a used relationship type</p>
				<p>Note: This action CANNOT be undone!</p>
				<p><input class=button type=submit value="Delete Role"></p>
				</td>
			</tr>
		</table>
		</form>
