<?php
/**
 * install/updateto1.99.2.php - Update the database from a previous version of xrms
 * formerly named install/updateto2.0
 *
...
Header('Location: updateto1.99.3.php'); // opportunity workflow updates
