 ...
 *
 * $Id: edit-2.php,v 1.5 2004/05/13 16:36:46 braverock Exp $
 */
...
$sql = "update users set role_id = $role_id, last_name = " . $con->qstr($last_name, get_magic_quotes_gpc()) . ", first_names = " . $con->qstr($first_names, get_magic_quotes_gpc()) . ", username = " . $con->qstr($username, get_magic_quotes_gpc()) . ", email = " . $con->qstr($email, get_magic_quotes_gpc()) . ", gmt_offset = $gmt_offset where user_id = $edit_user_id";
$con->execute($sql);
