 ...
 * List account-status
 *
 * $Id: some.php,v 1.11 2007/10/17 15:05:18 randym56 Exp $
 */
...
if ($rst) {
    while (!$rst->EOF) {
        $table_rows .= '<tr>';
        $table_rows .= '<td class=widget_content>' . $rst->fields['account_status_id'] . '</td>';
...
<div id="Main">
    <div id="Content">
        ...
        <table class=widget cellspacing=1>
            <tr>
                <td class=widget_header colspan=5><?php echo _("Account Statuses"); ?></td>
            </tr>
            <tr>
...
/**
 * $Log: some.php,v $
 * Revision 1.11  2007/10/17 15:05:18  randym56
