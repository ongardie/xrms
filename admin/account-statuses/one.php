    ...
    <tr>
        ...
        <table class=widget cellspacing=1>
            ...
            <tr>
                ...
                <td class=widget_content_form_element><input type=text size=30 name=account_status_display_html value="<?php  echo htmlspecialchars($account_status_display_html); ?>"></td>
            </tr>
            <tr>
