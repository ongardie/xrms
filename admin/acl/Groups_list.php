 ...
 *
 * @todo
 * $Id: Groups_list.php,v 1.3 2005/02/14 23:34:06 vanmer Exp $
 */
...
?>
<input type="button" class="button" value="Add New" onclick="javascript: location.href='one_Groups.php?form_action=new&return_url=Groups_list.php'">
</div></div></form>
