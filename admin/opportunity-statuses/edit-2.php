...
$sql = "update opportunity_statuses set opportunity_status_short_name = " . $con->qstr($opportunity_status_short_name, get_magic_quotes_gpc()) . ", opportunity_status_pretty_name = " . $con->qstr($opportunity_status_pretty_name, get_magic_quotes_gpc()) . ", opportunity_status_pretty_plural = " . $con->qstr($opportunity_status_pretty_plural, get_magic_quotes_gpc()) . ", opportunity_status_display_html = " . $con->qstr($opportunity_status_display_html, get_magic_quotes_gpc()) . ", opportunity_status_long_desc = " . $con->qstr($opportunity_status_long_desc, get_magic_quotes_gpc()) . " WHERE opportunity_status_id = $opportunity_status_id";
$con->execute($sql);
