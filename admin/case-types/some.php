 ...
 * View all Case Types
 *
 * $Id: some.php,v 1.4 2004/06/14 21:48:25 introspectshun Exp $
 */
...
<div id="Main">
    <div id="Content">
        ...
        <table class=widget cellspacing=1>
            <tr>
                <td class=widget_header colspan=4>Case Types</td>
            </tr>
            <tr>
    ...
    <div id="Sidebar">
        ...
        <table class=widget cellspacing=1>
            <tr>
                <td class=widget_header colspan=2>Add New Case Type</td>
            </tr>
            <tr>
