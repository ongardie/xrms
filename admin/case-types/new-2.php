 ...
 *
 * $Id: new-2.php,v 1.7 2010/12/06 22:18:54 gopherit Exp $
 */
...
// doing nothing
if ((strlen($case_type_short_name) > 0) OR (strlen($case_type_pretty_name) > 0)) {

    // Set defaults if we didn't get everything we need
    if (strlen($case_type_pretty_name) == 0) {
        $case_type_pretty_name = $case_type_short_name;
    }
    if (strlen($case_type_pretty_plural) == 0) {
        $case_type_pretty_plural = $case_type_pretty_name;
    }
    if (strlen($case_type_display_html) == 0) {
        $case_type_display_html = $case_type_pretty_name;
    }
...
/**
 * $Log: new-2.php,v $
 * Revision 1.7  2010/12/06 22:18:54  gopherit
