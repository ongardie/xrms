<?php
/**
 * The main page for the serverinfo plugin
 *
 * $Id: serverinfo.php,v 1.1 2004/07/06 19:57:02 gpowers Exp $
 */
...
$sql  = "SELECT svrinfo.server_id,svrinfo.value,companies.company_name,companies.company_id ";
$sql .= "FROM svrinfo, svrinfo_servers, companies ";
$sql .= "WHERE svrinfo.element_id='1' ";
$sql .= "AND svrinfo.server_id=svrinfo_servers.server_id ";
$sql .= "AND svrinfo_servers.company_id=companies.company_id ";
$sql .= "ORDER BY ";
$sql .= ($sort_by_companyname) ? "companies.company_name" : "svrinfo.value";
    ...
    <table class=widget cellspacing=1 width="100%">
      ...
      if ($rst) {
            while (!$rst->EOF) {
              ...
              $server_id = $rst->fields['server_id'];

              $link = "one.php?server_id=$server_id&company_id=$company_id&return_url=$this";
