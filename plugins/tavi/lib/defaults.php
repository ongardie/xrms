<?php
// $Id: defaults.php,v 1.1 2005/04/12 20:45:12 gpowers Exp $
...
// $UseCaptcha, if set, generates a random phrase, and presents it as a
// ascii art. When saving the user needs to correctly identify this phrase
// to be able to save the changes made
$UseCaptcha = 1;

// $FigletFontdir, only used if $UseCaptcha is set, references to a directory
// containing figletfonts-files. See website for fonts and more info on figlets
// and more fonts: http://www.figlet.org/
//   If a relative directory is given, then it's tried against the different
// directories in the include_path parameter. This should include both the
// directory where the config.php resides, and where the main code exists.
$FigletFontdir = "fonts/";
