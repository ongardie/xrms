 ...
 *
 * $Id: some.php,v 1.1 2004/11/10 07:27:49 gpowers Exp $
 */
...
if ($rst) {
        ...
        $table_rows .= 'private_sidebar_bottom';
        $table_rows .= '</td>';
                $table_rows .= '</tr>';
                $rst->movenext();
        }
...
<div id="Main">
    ...
    <div id="Sidebar">
		...
		<table class=widget cellspacing=1>
			<tr>
                <td class=widget_header colspan=2><?php echo _("Add New Info Type"); ?></td>
			</tr>
			<tr>
                <td class=widget_label_right><?php echo _("Name"); ?></td>
				<td class=widget_content_form_element><input type=text name=info_type_name size=30></td>
			</tr>
			<tr>
                <td class=widget_label_right><?php echo _("Display On"); ?></td>
				<td class=widget_content_form_element><input type=text name=display_on size=30></td>
			</tr>
			<tr>
