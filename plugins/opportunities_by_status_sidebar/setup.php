...
// copyright 2007-2008 Glenn Powers <glenn@net127.com>

function xrms_plugin_init_opportunities_by_status_sidebar() {
    global $xrms_plugin_hooks;
    $xrms_plugin_hooks['private_sidebar_top']['opportunities_by_status_sidebar'] = 'opportunities_by_status_sidebar';
}


function  opportunities_by_status_sidebar() {
