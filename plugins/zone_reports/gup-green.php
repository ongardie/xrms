 ...
 *
 * $Id: gup-green.php,v 1.1 2007/12/10 23:30:16 gpowers Exp $
 */
...
$opp_sidebar_form_id='GreenOpportunities';
$opp_sidebar_header=_("<font color=green size=\"+1\">Green Zone</font>");
$target=$http_site_root.current_page();

// $con->debug=1;

$opportunity_rows = "<div id='OpportunitiesGreenPager'>";
...
and activities.scheduled_at > '" . $today . "' ";
...
$opp_pager_columns = new Pager_Columns('OpportunitiesGreenPager', $columns, $opportunity_sidebar_default_columns, $opp_sidebar_form_id);
...
$pager = new GUP_Pager($con, $opportunity_sql, null,$opp_sidebar_header, $opp_sidebar_form_id, 'OpportunitiesGreenPager', $columns, false, true);
