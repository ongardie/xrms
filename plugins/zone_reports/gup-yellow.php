 ...
 *
 * $Id: gup-yellow.php,v 1.1 2007/12/10 23:30:16 gpowers Exp $
 */
...
$opp_sidebar_form_id='YellowOpportunities';
$opp_sidebar_header=_("<font color=orange size=\"+1\">Yellow Zone</font>");
$target=$http_site_root.current_page();

// $con->debug=1;

$opportunity_rows = "<div id='OpportunitiesYellowPager'>";
...
where opportunities.opportunity_status_id < '7'
and opportunities.opportunity_status_id > '4'
and opportunities.opportunity_status_id = os.opportunity_status_id
...
and activities.activity_type_id = '12'
and activities.scheduled_at < '" . $twoweeks . "' ";
...
$opp_pager_columns = new Pager_Columns('OpportunitiesYellowPager', $columns, $opportunity_sidebar_default_columns, $opp_sidebar_form_id);
...
$pager = new GUP_Pager($con, $opportunity_sql, null,$opp_sidebar_header, $opp_sidebar_form_id, 'OpportunitiesYellowPager', $columns, false, true);
