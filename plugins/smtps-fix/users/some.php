 ...
 * List system users.
 *
 * $Id: some.php,v 1.1 2008/03/15 16:54:31 randym56 Exp $
 */
    ...
    <div id="Sidebar">
        ...
        <table class=widget cellspacing=1 width="100%">
            ...
            <tr>
                ...
                <td class=widget_content_form_element><input type=text size=6 name=smtpsPort value="<?php  echo $smtpsPort; ?>"></td>
            </tr>
            <tr>
