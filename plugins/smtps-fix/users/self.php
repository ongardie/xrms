 ...
 *
 * $Id: self.php,v 1.1 2008/03/15 16:54:31 randym56 Exp $
 */
...
<div id="Main">
    <div id="Content">
        ...
        <input type=hidden name=record_status value="<?php  echo $record_status; ?>">
        ...
        <table class=widget cellspacing=1>
            ...
            <tr>
                <td class=widget_label_right><?php echo _("SMTP Login ID"); ?></td>
                <td class=widget_content_form_element><input type=text size=40 name=smtpsID value="<?php  echo $smtpsID; ?>"></td>
            </tr>
            <tr>
                <td class=widget_label_right><?php echo _("SMTP Password"); ?></td>
                <td class=widget_content_form_element><input type=password size=40 name=smtpsPW value="<?php  echo $smtpsPW; ?>"></td>
            </tr>
            <tr>
                <td class=widget_label_right><?php echo _("SMTP Server"); ?></td>
                <td class=widget_content_form_element><input type=text size=40 name=smtpsHost value="<?php  echo $smtpsHost; ?>"></td>
            </tr>
            <tr>
                <td class=widget_label_right><?php echo _("SMTP Port"); ?></td>
                <td class=widget_content_form_element><input type=text size=6 name=smtpsPort value="<?php  echo $smtpsPort; ?>">(Usually 25 or 587 or 5125 - secure = 465)</td>
            </tr>
            <tr>
