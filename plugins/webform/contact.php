<?php
/**
 * WebForm Plugin - index.php
 *
 * @author Nic Lowe
 *
 * This file can serve asd a template for  integrating the webform
 * 'plugin' into your code
 *
 * NOTE: This "Contact Us" form will need to be modified to work in your environment!
 *       There is no simple way to provide a "drop in" form that you can use.
 *       You need to read and understand this code before using it.
 *
 * You need to change settings in vars_webform.php before anything will work.
 *
 * Note that this form will probably need to be modified to collect the information you require.
 *
 * For Example, the State/Province list is for Australia.
 */
...
<?php
 /**
 * $Log: contact.php,v $
 * Revision 1.6  2006/10/05 11:23:22  braverock
 ...
 *
 * 2006/10/05 braverock : Manually move Log
