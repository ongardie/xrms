 ...
 * system.
 *
 * $Id: setup.php,v 1.1 2004/05/06 13:45:45 gpowers Exp $
 */


function xrms_plugin_init_voicemail() {
    global $xrms_plugin_hooks;
    $xrms_plugin_hooks['menuline']['voicemail'] = 'voicemail';
}
...
function voicemail() {
    ...
    echo "&nbsp;<a href='$http_site_root/plugins/voicemail/voicemail.php'>Voice Mail</a>&nbsp;&bull;\n";
}
