...
function misc_db_data($con) {
    ...
    if (confirm_no_records($con, 'countries')) {
        ...
        $rst = $con->execute($sql);
        $sql ="insert into countries (address_format_string_id, country_name, un_code, iso_code2, iso_code3, telephone_code) values (1, 'C�te d�Ivoire', '384', 'CI', 'CIV', '225')";
        $rst = $con->execute($sql);
        ...
        $rst = $con->execute($sql);
        $sql ="insert into countries (address_format_string_id, country_name, un_code, iso_code2, iso_code3, telephone_code) values (1, 'R�union', '638', 'RE', 'REU', '262')";
        $rst = $con->execute($sql);
        ...
        $rst = $con->execute($sql);
        $sql ="insert into countries (address_format_string_id, country_name, un_code, iso_code2, iso_code3, telephone_code) values (1, 'S�o Tom� and Principe', '678', 'ST', 'STP', '239')";
        $rst = $con->execute($sql);
...
function user_preferences_db_data($con) {
    ...
    add_preference_option($con, $undefined_company_method, 'household', 'New Company uses Contact Last Name + Household');
