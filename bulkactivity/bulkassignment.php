<?php
  ...
  * bulkassignment.
  *
  * $Id: bulkassignment.php,v 1.8 2010/12/17 21:29:05 gopherit Exp $
  */
  ...
  // Get the Company Account Status Menu
  ...
  // Build the Company Search Results Array
  ...
  // Buils the Company Search Results table row set
  $sql = "SELECT "
  ...
  if ($rst) {
      while (!$rst->EOF) {
        $contact_rows .= '<tr>';
        $contact_rows .= '<td class="widget_content_form_element"><input type="checkbox" name="array_of_companies[]" id="array_of_companies_' . $_x++ . '" value="' . $rst->fields['company_id'] . '" checked="checked"></td>';
...
<div id="Main">
    ...
    <table class="widget" cellspacing="1">
    <tr>
           <td class=widget_label style="width: 10%;"><?php echo _("Set category"); ?></td>
           <td class=widget_content_form_element style="width: 20%;"><?php echo $company_category_menu; ?></td>
           <td class=widget_label>
                <input type=checkbox id=unlink_category name=unlink_category value=1>
                <?php echo _("Select check box to unlink selected Companies from the Category"); ?>
            </td>
    </tr>
    </table>
    ...
    <table class="widget" cellspacing="1">
    <tr>
           <td class=widget_label style="width: 10%;"><?php echo _("Set campaign"); ?></td>
           <td class=widget_content_form_element style="width: 20%;"><?php echo $campaign_menu; ?></td>
           <td class=widget_label>
                <input type=checkbox id=unlink_campaign name=unlink_campaign value=1>
                <?php echo _("Select check box to unlink selected Companies from the Campaign"); ?>
            </td>
    </tr>
    </table>
    <table class="widget" cellspacing="1">
        <tr>
            <td class=widget_header colspan=6><?php echo _("Confirm Selection"); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="widget_content_form_element" colspan="6">
                ...
                <input class="button" type="button" value="<?php echo _('Cancel'); ?>" onclick="location.href='<?php echo $http_site_root . $return_url; ?>'">
            </td>
        </tr>
    </table>
    </form>
...
end_page();
  ...
  * Revision 1.8  2010/12/17 21:29:05  gopherit
