...
* $Id: bulkactivity-1.php,v 1.2 2009/02/05 23:06:12 randym56 Exp $
...
if ($rst) {
...

        {
            ...
            $scheduled_at = date($datetime_format,$current_time);

            $ends_at = date($datetime_format,$current_time+1);
 ...
 * Revision 1.2  2009/02/05 23:06:12  randym56
