 ...
 *
 * $Id: opportunities-size-by-opportunity-status.php,v 1.9 2005/03/09 21:06:13 daturaarutad Exp $
 */
    ...
    <div id="ContentFullWidth">
        ...
        <tr>
            <td class=widget_content_graph>
                  <img src="jpgraph-opportunities-size-by-opportunity-status.php<?php
                  if ( $all_users )
                  {
                    echo "?all_users=on"; 
                  }
                  ...
                  if ($hide_closed_opps==true)
                  {
                     echo "&hide_closed_opps=true";
                  }  
