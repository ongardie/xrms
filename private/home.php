 ...
 *
 *
 * $Id: home.php,v 1.58 2005/06/27 16:34:47 daturaarutad Exp $
 */
...
$activities_widget =  GetActivitiesWidget($con, $results_view_type, $search_terms, $form_name, _('Search Results'), $session_user_id, $return_url, $extra_where);
